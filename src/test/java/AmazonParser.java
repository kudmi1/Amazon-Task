...
public class AmazonParser {
  ...
  public void testAmazonSearch() {
    ...
    bookFilter.click();
    WebElement bookOption = driver.findElement(
            By.cssSelector("#searchDropdownBox option[value='search-alias=stripbooks-intl-ship']"));
    bookOption.click();
    ...
    List<WebElement> bookElements = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(
    ...
    for (WebElement element : bookElements) {
      // Вилучаємо назву
      WebElement titleElement = wait.until(ExpectedConditions.visibilityOf(element.findElement(
              By.cssSelector("h2.a-size-mini"))));
      ...
      WebElement authorElement = wait.until(ExpectedConditions.visibilityOf(element.findElement(
              By.cssSelector(".a-row.a-size-base.a-color-secondary"))));
      ...
      try {
        WebElement bestsellerElement = element.findElement(
                By.xpath(".//span[@class='a-badge-text']"));
    ...
    String targetBookUrl =
            "https://www.amazon.com/Head-First-Java-Kathy-Sierra/dp/0596009208/ref=sr_1_2?dchild=1&keywords=Java&qid=1610356790&s=books&sr=1-2";
